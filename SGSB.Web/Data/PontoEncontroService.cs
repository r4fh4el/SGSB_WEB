...
namespace SGSB.Web.Data
{
    public class PontoEncontroService
    {
        ...
        public async Task<List<PontoEncontro>> GetPontoEncontro()
        {
            var objPontoEncontro = await http.GetFromJsonAsync<List<PontoEncontro>>( Infra.Constantes.URI +"/API/ListarPontoEncontro");

            return objPontoEncontro.ToList();

        }
        public async Task<List<PontoEncontro>> GetBuscarListPorIdPontoEncontro(int id)
        {
