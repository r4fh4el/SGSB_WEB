...
{
    [Table("SUB_BACIA")]
    public class SubBacia : Notifica
    {
        [Column("ID")]
        [Key]
        ...
        [ForeignKey("CARACTERISTICA_BACIA_ID")]
        [Column(Order = 1)]
        public int CaracteristicaBaciaId { get; set; }
        public virtual CaracteristicaBacia? CaracteristicaBacia { get; set; }
